## WFO TENs: shaping the global classification
...
TENs are encouraged to work at the family level, but we recognize that in some cases a different taxonomic rank may be more appropriate. Above the rank of family, we have 'major group' TENs (e.g. [bryophytes](https://about.worldfloraonline.org/tens/bryophytesgroup), [pteridophytes](https://about.worldfloraonline.org/tens/pteridophyte-phylogeny-group) and [conifers](https://about.worldfloraonline.org/tens/conifers)) and order-level TENs (e.g. [Caryophyllales](https://about.worldfloraonline.org/tens/caryophyllales-org), [Commelinales](https://about.worldfloraonline.org/tens/commelinales) and [Dipsacales](https://about.worldfloraonline.org/tens/dipsacales-caprifoliaceae-viburnaceae)). We also have a few suprageneric TENs (e.g. Papaveraceae tribe [Papaverae](https://about.worldfloraonline.org/tens/papaveraceae_tribe_papaverae)), although these are seen as 'stepping stones' that will later become part of a family-level TEN.
...
If you wish to join an existing TEN you can contact the TEN Lead directly using details provided on the TEN page, or you can email the TEN Manager to ask what to do [here.](mailto:taxwg@worldfloraonline.org)
...
TENs have been formed through a variety of pathways. Some have come from existing networks, such as [SolanaceaeSource](https://about.worldfloraonline.org/tens/solanaceaesource-org) and the [International Compositae Alliance](https://about.worldfloraonline.org/tens/the-international-compositae-alliance), others have arisen from ongoing collaborations, as was the case for [Zingiberaceae](https://about.worldfloraonline.org/tens/zingiberaceae-resource-centre) and [Begoniaceae](https://about.worldfloraonline.org/tens/begonia-resource-centre). Many TENs are now being formed de novo by bringing together researchers around the world who may or may not have worked together in the past, resulting in new networks and fostering new collaborations.
...
Increasingly, TENs are contributing directly into WFO by curating and correcting data in the [Rhakhis Taxonomic Editor](https://rhakhis-live.rbge.info). Rhakhis is a user-friendly online tool for curating names and classification data. People log into Rhakhis with their ORCID iD and make edits in the part of the taxonomic hierarchy to which they have been assigned. TEN Leads are assigned editorial rights at the top level of their taxonomic group (usually at the rank of family), and they can assign editorial rights to others at any level within this part of the hierarchy. ORCID iDs are used to track people's contributions and generate the authorship for outputs of the WFO global classification (e.g. the WFO Plant List in [Zenodo](https://zenodo.org/records/12171908) and Catalogue of Life's [ChecklistBank](https://www.checklistbank.org/dataset/2004/about)).

### What resources are available for Rhakhis users?

[Rhakhis Users' Handbook](https://plant-list-docs.rbge.info/rhakhis/) gives full instructions and video walkthroughs on how to use the Rhakhis user interface. The TEN manager is available for help users with problems using Rhakhis and additional online training can be arranged.

[Rhakhis (sandbox)](https://rhakhis-test.rbge.info) is available for anyone wanting to familiarise themselves with Rhakhis and have a play with sample data. You only need an ORCID iD to get started, and you don't need to worry about messing things up as any changes to the data are reset every 24 hours.
...
Larger Families (more than 500 species) that do not have a TEN are found [here](https://github.com/worldflora/wfo-tens/wiki/Large-Families-more-than-500-species-lacking-a-Taxonomic-Expert-Network)

Smaller Families (less than 500 species) that do not have a TEN are found [here](https://github.com/worldflora/wfo-tens/wiki/Small-Families-with-less-than-500-species-lacking-a-Taxonomic-Expert-Network)

If you would like to discuss forming a new TEN or wish to join an existing TEN please do get in touch with the [TEN Manager.](mailto:taxwg@worldfloraonline.org)
